...
* **Specific Problem:** Given historical measurements of atmospheric pollutants (PM2.5, PM10) for a set of US cities, can we predict the next-day Air Quality Index (AQI) category being Good, Moderate, Unhealthy for Sensitive Groups, Unhealthy, or Very Unheathy using a multi-class classification model?
